<div class="modal fade text-left" id="employeeTypeModal" tabindex="-1" role="dialog" aria-labelledby="majorModal"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="majorModal">Tambah Jenis Staff</h4>
